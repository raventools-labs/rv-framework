		...
		var dialog = 
			`<div class="modal-dialog modal-dialog-icon" role="document">
				<div class="modal-content">
					...
					<div id="modal-body-${property}" class="modal-body">
		
					${icons.list.map(icon => 
						`<div class="btn-group" role="group">
							<button type="button" class="btn btn-light"
								onclick="icons.setIcon('${property}','${icon}')" data-dismiss="modal">
								<i title="${icon}" class="fa fa-${icon} fa-xs" aria-hidden="true"></i>
							</button>
						</div>`
					).join('')}
					</div>
